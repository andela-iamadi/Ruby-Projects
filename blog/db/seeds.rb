...
Messages = Message.create([
	{
		context: "Hey bro. Where you at? I'v gotten to Sabo. Already in a keke bound for Amity.  :)"
	},
	{
		context: "Now? Good. Let's meet there!"
	}
])


# Seeding the tags and destinations table

t1 = Tag.create(title: "Beaches", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach01.jpg")
D1 = Destination.create(name: "Ipanema", description: "The beach of Ipanema is known for its elegant development and its social life.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach02.jpg", tag_id: t1.id)
...
Booking.create(name: "John Smith", message: "Could you make this reservation for me? I love the ocean view!!!", destination_id: D1.id)
Booking.create(name: "William Carter", message: "Stayed in Ipanema for a month. Was a very unforgettable experience.", destination_id: D1.id)
